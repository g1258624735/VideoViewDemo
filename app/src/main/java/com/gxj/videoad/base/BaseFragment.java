...
public abstract class BaseFragment extends Fragment {
    ...
    public void onResume() {
        ...
        if (mContext.getSupportActionBar() != null) {
            mContext.getSupportActionBar().setDisplayHomeAsUpEnabled(!(this instanceof HomeFragment));
            mContext.getSupportActionBar().setTitle(getTitle());
        }
    }
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        mBaseView = onCreateView(inflater, container);
        return mBaseView;
    }
     ...
     * onCreateView
     */
    protected abstract View onCreateView(@NonNull LayoutInflater inflater, ViewGroup container);
